...
CREATE TABLE nzb ( id INTEGER PRIMARY KEY, releaseDate TEXT, origYear TEXT, tags TEXT, series TEXT, issue INT, url TEXT, hash TEXT );
CREATE TABLE history ( id INTEGER PRIMARY KEY, time TEXT, name TEXT, issue INT, action TEXT );
CREATE TABLE meta ( id INTEGER PRIMARY KEY, time TEXT, asset TEXT, hash TEXT );
